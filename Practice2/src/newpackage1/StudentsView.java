...
public class StudentsView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnAddTbleWriteFile = new javax.swing.JButton();
        ...
        btnAddTbleWriteFile.setText("Add To Table Write To File");
        btnAddTbleWriteFile.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAddTbleWriteFileActionPerformed(evt);
            }
        });
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(chk5))
                                    .addComponent(btnAddTbleWriteFile)
                                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnAddTbleWriteFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddTbleWriteFileActionPerformed
        ...
        if (txtId.getText().length() < 2) {
            ...
            for (int i = 0; i < students.size(); i++) {
                ...
                Utils.writeToFile("epic", students);
            }
            lblMsg.setText("Successfully added into table adn write to file");
        }
    }//GEN-LAST:event_btnAddTbleWriteFileActionPerformed
    ...
    private void btnReadFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReadFileActionPerformed
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel) tblDisplay.getModel();
        Utils.readDataFromFile("epic", model);
    ...
    private javax.swing.JButton btnAddTbleWriteFile;
